.. title:: How to use Cognito Forms to populate Excel and PDF document templates in Power Automate (Microsoft Flow) and Azure Logic Apps
...
Create Excel and PDF documents from Cognito Forms in Power Automate
====================================================================
