You can insert values from your data using tokens. Let us assume, your data has property "invoiceNumber". In this case, you can include it using token :code:`{{invoiceNumber}}`. 
