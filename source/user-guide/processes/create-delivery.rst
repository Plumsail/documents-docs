...
.. Note:: 
  ...
  Also, you can `use Power Automate (Microsoft Flow) <../../getting-started/use-from-flow.html#start-process-from-flow>`_ and `Zapier <../../getting-started/use-from-zapier.html>`_ to handle documents generated by your process instead of deliveries or together with them.