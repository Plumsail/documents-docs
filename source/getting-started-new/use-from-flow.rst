...
You can use `Plumsail Documents connector <https://emea.flow.microsoft.com/en-us/connectors/shared_plumsail/plumsail-documents/>`_ in Power Automate (Microsoft Flow) for two scenarios:
...
In this case, use `the rich set of Power Automate (Microsoft Flow) actions <../flow/actions/document-processing.html>`_ from Plumsail Documents connector. 
