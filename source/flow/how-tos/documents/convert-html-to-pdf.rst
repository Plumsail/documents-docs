.. title:: How to convert HTML to PDF using Power Automate (Microsoft Flow) and Azure Logic Apps

.. meta::
   :description: Automatically convert HTML to PDF using Power Automate and Azure Logic Apps
