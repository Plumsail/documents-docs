...
We've already created a Microsoft Form. We will use data from its submission in our Flow. If you haven't created MS Forms before, follow `this link <https://support.office.com/en-gb/article/create-a-form-with-microsoft-forms-4ffb64cc-7d5d-402f-b82e-b1d49418fd9d>`_ to learn how to do it.
...
We need to start the Flow everytime somebody submits it. For that, search for *Microsoft Forms* in Power Automate and set *Microsoft Forms - When a response is submitted* as a trigger.
...
.. image:: ../../../_static/img/flow/how-tos/send-email-msform-xlsx.png
    :alt: send an email
